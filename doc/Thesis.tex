...
\subsubsection{The algorithm}
The third algorithm is first written by Susan Horwitz\cite{horwitz-interproc}, and has been a base for different slicing techniques, used by \cite{use-of-slicing-horwitz}, \cite{program-analysis-via-graph-reachability-reps}, \cite{slicing-with-jumps} and \cite{slicing-oop}. 
